...
/* 
Это же опенсорс, вся документация на github : https://github.com/libcpr/ 

Там есть ссылка на нормальный вид: https://docs.libcpr.org/

Плюс можно смотреть примеры с github  репозитория, для более детального изучения.

Сделайте запрос к сервису httpbin.org, отправив несколько дополнительных аргументов с данными.
